...
<div id="anychartconteudo2"></div>
            ...
            <div class="col col-md-6">
                <div class="row" style="height: 100%">
                    <div class="col col-md-12">
                        <div class="card cards-supeiror" style="height: 100%">
                            <div class="card-body">
                                <h1 class="d-xl-flex justify-content-xl-center titulos">Satisfação - Anual</h1>
        ...
        <div class="progress mx-auto" data-value='70'>
          ...
          <div class="progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
              <div class="h3 text-center">70%<br>Ótimo</div>
          </div>
        ...
        <div class="progress mx-auto" data-value='20'>
          ...
          <div class="progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
            <div class="h3 text-center">20%<br>Regular</div>
          </div>
        </div>
        <!-- END -->
        ...
        <div class="progress mx-auto" data-value='10'>
          ...
          <div class="progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
            <div class="h3 text-center">10%<br>Ruim </div>
          </div>
        </div>
        <!-- END -->
        ...
        <div class="progress mx-auto" data-value='10'>
          ...
          <div class="progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
              <div class="h3 text-center">10%<br>N/A</div>
          </div>
        </div>
        <!-- END -->
...
ac_add_style(".anychart-embed-samples-bct-column-chart-04{width:100%;height:255px;}");
    ...
    var data = anychart.data.set([
        <?php if($janeiro > 0 && $janeiroF > 0) {
         echo "['Jan',$janeiro, $janeiroF, '#1d42898f', '#f1be488f', null, {enabled: true}],";   
        }
?>
      
      ["Fev", <?php echo $fevereiro;?>, <?php echo $fevereiroF;?>,"#1d42898f", "#f1be488f", null, {enabled: true}],
      ["Mar", <?php echo $marco;?>, <?php echo $marcoF;?>, "#1d42898f", "#f1be488f", null, {enabled: true}],
      ["Abr", <?php echo $abril;?>, <?php echo $abrilF;?>, "#1d42898f", "#f1be488f", null, {enabled: true}],
      ["Mai", <?php echo $maio;?>, <?php echo $maioF;?>, "#1d42898f", "#f1be488f", null, {enabled: true}],
      ["Jun", <?php echo $junho;?>, <?php echo $junhoF;?>, "#1d42898f", "#f1be488f", null, {enabled: true}],
      ["Jul", <?php echo $julho;?>, <?php echo $julhoF;?>, "#1d42898f", "#f1be488f", null, {enabled: true}],
      ["Ago", <?php echo $agosto;?>, <?php echo $agostoF;?>, "#1d42898f", "#f1be488f", null, {enabled: true}],
      ["Set", <?php echo $setembro;?>, <?php echo $setembroF;?>, "#1d42898f", "#f1be488f", null, {enabled: true}],
      ["Out", <?php echo $outubro;?>, <?php echo $outubroF;?>, "#1d42898f", "#f1be488f", null, {enabled: true}],
      ["Nov", <?php echo $novembro;?>, <?php echo $novembroF;?>, "#1d42898f", "#f1be488f", null, {enabled: true}],
      ["Dez", <?php echo $dezembro;?>, <?php echo $dezembroF;?>, "#1d42898f", "#f1be488f", null, {enabled: true}]
    ]);
