...
$cTotal = mysqli_query ($conexao, "SELECT count(codticket) AS totalTicket FROM $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and coddepartamento = $DEPARTAMENTOLOJA");
$totalTicket = mysqli_fetch_assoc($cTotal);

$cTotalFechado = mysqli_query($conexao, "SELECT count(codticket) AS totalFechado from $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and codstatus in (3,13) and coddepartamento = $DEPARTAMENTOLOJA");
$totalFechado = mysqli_fetch_assoc($cTotalFechado);

$cFabrica = mysqli_query($conexao, "SELECT count(codticket) AS totalFabrica from $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and codstatus = 11 and coddepartamento = $DEPARTAMENTOLOJA");
$totalFabrica = mysqli_fetch_assoc($cFabrica);

$cInterno = mysqli_query($conexao, "SELECT count(codticket) AS totalInterno from $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and codstatus in (4, 5, 14, 15) and coddepartamento = $DEPARTAMENTOLOJA");
$totalInterno = mysqli_fetch_assoc($cInterno);

$cEmpresa = mysqli_query($conexao, "SELECT count(codticket) AS totalEmpresa from $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and codstatus in (1, 10) and coddepartamento = $DEPARTAMENTOLOJA");
$totalEmpresa = mysqli_fetch_assoc($cEmpresa);

$cCliente = mysqli_query($conexao, "SELECT count(codticket) AS totalCliente from $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and codstatus = 2 and coddepartamento = $DEPARTAMENTOLOJA");
$totalCliente = mysqli_fetch_assoc($cCliente);

$cAbertosMes = mysqli_query($conexao, "SELECT COUNT(codticket) AS abertosMes, DATE_FORMAT(dtabertura, '%c') as mesAbertura FROM $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and coddepartamento = $DEPARTAMENTOLOJA group BY mesAbertura");
...
$cFechadosMes = mysqli_query($conexao, "SELECT COUNT(codticket) AS fechadosMes, DATE_FORMAT((IF(dtfechamento = '1969-12-31', dtalteracao, dtfechamento)), '%c') as mesFechamento FROM $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and coddepartamento = $DEPARTAMENTOLOJA and codstatus in(3, 13) group BY mesFechamento");
...
$caberto3Dia = mysqli_query($conexao, "SELECT count(codticket) AS abertos3Dia FROM $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and dtfechamento <= '$DATAFINAL' and (dtfechamento - dtabertura >= 2 ) AND (dtfechamento - dtabertura <= 3 ) and coddepartamento = $DEPARTAMENTOLOJA and codstatus in(3, 13)");
$tabertosFechados3Dia = mysqli_fetch_assoc($caberto3Dia);

$caberto7Dia = mysqli_query($conexao, "SELECT count(codticket) AS abertos7Dia FROM $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and dtfechamento <= '$DATAFINAL' and (dtfechamento - dtabertura >= 4 ) AND (dtfechamento - dtabertura <= 7 ) and coddepartamento = $DEPARTAMENTOLOJA and codstatus in(3, 13)");
$tabertosFechados7Dia = mysqli_fetch_assoc($caberto7Dia);

$caberto30Dia = mysqli_query($conexao, "SELECT count(codticket) AS abertos30Dia FROM $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and dtfechamento <= '$DATAFINAL' and (dtfechamento - dtabertura >= 8 ) AND (dtfechamento - dtabertura <= 30 ) and coddepartamento = $DEPARTAMENTOLOJA and codstatus in(3, 13)");
$tabertosFechados30Dia = mysqli_fetch_assoc($caberto30Dia);

$caberto90Dia = mysqli_query($conexao, "SELECT count(codticket) AS abertos90Dia  FROM $DATABASE.ticket WHERE dtabertura >= '$DATAINICIAL' and dtfechamento <= '$DATAFINAL' and (IF(dtfechamento = '1969-12-31', CURRENT_DATE, dtfechamento) - dtabertura > 30 ) and coddepartamento = $DEPARTAMENTOLOJA and codstatus in(3, 13)");
