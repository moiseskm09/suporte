...
<body class="tema" id="fullbiloja">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card cards-supeiror">
                    <div class="card-body">
                        <h4 class="d-lg-flex align-items-lg-center justify-content-xl-center card-title titulos text-center"><i class="fas fa-chart-line" style="color:#f58322"></i>&nbsp;BI ARIUS LOJA</h4>
                        <h6 class="text-muted card-subtitle float-end"></h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg col-md col-6">
                <div class="card cards-supeiror">
                    <div class="card-body">
                        ...
                        <h6 class="text-muted card-subtitle mb-2 subtitulo">Pendente Empresa</h6>
                    </div>
                </div>
            </div>
            <div class="col-lg col-md col-6">
